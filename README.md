...
This project is a **hands-on learning exercise** in machine translation using **RNN-based models** implemented with
**PyTorch**. The goal is to understand the fundamental architecture and training process of **sequence-to-sequence**
models for translating Chinese to English by using [AI Challenger 2017](https://tianchi.aliyun.com/dataset/174937).
