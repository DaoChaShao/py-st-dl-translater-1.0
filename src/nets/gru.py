...
class GRUNet(nn.Module):
    ...
    def __init__(
        ...
        self._gru = nn.GRU(self._H, self._M, self._C, batch_first=True, bidirectional=bid, dropout=dropout)
    ...
    def _init_hidden(self, batch_size: int, accelerator: device) -> Tensor:
        ...
        :return: initial hidden state tensor, shape (num_layers, batch_size, hidden_dim)
        """
    ...
    def forward(self, X):
        ...
        output, hidden = self._gru(embeddings, h0)
